const CACHE='tripcraft-v109-final';
const CORE=['./','./index.html','./index-en.html','./manifest.webmanifest','./tripcraft-config.js','./tripcraft-v101.js','./tripcraft-v102.js','./tripcraft-v109.js','./tripcraft-v109-final.js','./tripcraft-logo-v109.png','./assets/tripcraft-logo.png','./assets/hero.jpg','./assets/austria.jpg','./assets/dolomites.jpg','./assets/greece.jpg','./assets/slovakia.jpg','./assets/vietnam.jpg','./icons/tripcraft-header-logo.png','./icons/icon-192.png','./icons/icon-512.png'];
